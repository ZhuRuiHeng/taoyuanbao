...
//		}
	...
	$('#xiayibu').on('tap',function(){
		var shoujihao = phone;
		console.log(shoujihao+'33333333333');
...
//		}
		...
		$.ajax({
			type : "get",
            url : apiRoot + "?m=Home&c=Member&a=upd_pass_yan",
            data : {
            	shoujihao : shoujihao,
			...
			success : function(data){
				...
				if(data.rt == 1){
					plus.webview.create('xiugai-word1.html','xiugai-word1.html').show('slide-in-right'); 
				}else if(data.rt == 0){
